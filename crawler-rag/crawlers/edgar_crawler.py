...
class EdgarCrawler(Crawler):
    def __init__(self, cfg: OmegaConf) -> None:
        ...
        self.cohere_client = cohere.Client(cfg.cohere.api_key)
        self.weaviate_client = Client(cfg.weaviate.url, AuthClientPassword(cfg.weaviate.api_key))
    ...
    for ticker in self.tickers:
        ...
        for filing in filings:
            ...
            with rate_limiter:
                ...
                # Chunk the document content into pieces of 512 tokens each
                chunks = [document_content[i:i+512] for i in range(0, len(document_content), 512)]
                for chunk in chunks:
